...
async def on_message(message):
    ...
    if message.content.startswith('^say'):
      ...
      if message.server.id == '519451035836874763, 535497714797117467' and 'https://' in message.content:
          await client.delete_message(message)
          await client.send_message(message.channel, f'Do not post link {message.author.name}')

      if message.server.id == '519451035836874763, 535497714797117467' and ':http://' in message.content:
          await client.delete_message(message)
          await client.send_message(message.channel, f'Do not post link {message.author.name}')
